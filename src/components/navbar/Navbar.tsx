...
const NavBar: React.FunctionComponent = () => {
    ...
    //                 Array.from(navList?.children).forEach(childs => {
    //                     childs.classList.remove('activeLink');
    //                 })
                ...
                <div className="nav-container">
                    ...
                    <nav>
                        ...
                        <ul id='nav-list' className="nav-list">
                            ...
                            <li><Link href="/recepi/1">Recipes</Link></li>
                            <li>
                                <span className="service">Features
                                    <ul className="nav-dropdown">
                                        <li><a href="#!">Add Recipe</a></li>
                                        <li><a href="#!">Search On Web</a></li>
                            ...
                            <li><Link href="/about">About</Link></li>
                            {
                                session.status === 'loading' ? <li>Loading</li> :
                                    session.status === 'unauthenticated' ? <li><Link href="/login" >Login</Link></li> :
                                        <li><Link href="#" onClick={signOut as any}>Logout</Link></li>
                            }
                        </ul>
                    </nav>
                </div>
